...
This function produces the required footnote symbol depending on the index you want. The input is a single or multiple numbers. These aren't ASCII friendly in R so this is useful to just have around.

```{r atsdr_footnote_symbol_example}
library(jspr)
